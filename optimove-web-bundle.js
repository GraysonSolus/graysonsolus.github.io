            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (browser === 'safari') {
                            console.log('Firing pushRegister because browser is safari');
                            pushManager.pushRegister(this.context);
                        }
                        return [2 /*return*/];
                }
