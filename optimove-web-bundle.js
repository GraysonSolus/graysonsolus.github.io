            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, navigator.permissions.query({ name: 'notifications' })
                            .then(function (status) { return status.addEventListener('change', function (event) { return __awaiter(_this, void 0, void 0, function () {
